  ...
  work: [
    {
      ...
      subtitle:'성과 지표를 노출 전략에 반영한 AI 콘텐츠 운영',
      ...
      details:'[WHY]\n콘텐츠별 생성 수·저장률·유료 구독 전환율을 매주 확인하면서, 생성 수가 높아도 저장·구독으로 이어지지 않는 콘텐츠가 있는 반면, 전환 성과가 좋은데도 충분히 노출되지 않는 콘텐츠가 있다는 것을 발견함\n\n[REASON]\n세 지표를 함께 보며 각 수치가 의미하는 이용자 반응을 구분해서 살핌. 저장률이 낮은 콘텐츠는 결과 확인 과정의 UX와 안내 문구를 점검해 원인을 찾았고, 구독 전환율이 높은 콘텐츠는 노출을 더 확장하면 성과를 키울 수 있다고 판단\n\n[HOW]\n전환율이 높은 콘텐츠는 상단 배치·프로모션으로 노출을 확장하고, 성과가 낮은 콘텐츠는 노출 우선순위를 낮춤. 안내 문구·UX도 함께 개선. 분석 결과를 팀에 공유하고 다음 주 운영에 반영하는 사이클을 반복',
  ...
  campaign: [
    {
      ...
      role:'팀장으로서 팀(10인)을 이끌며 기획·제작·운영 총괄\n10인의 논의가 비효율적으로 흘러가지 않도록 3개 소그룹으로 나눠 아이디어를 발전시킨 뒤 전체 회의에서 하나의 방향으로 조율\n에이전시 실무진과의 소통 창구를 맡아 피드백의 우선순위를 정리해 팀에 전달하고, 의견 충돌 시 기획 의도와 실행 가능성을 기준으로 조율',
